...
SMODS.Joker {
    ...
    rarity = 2,
    cost = 8,
    config = { extra = { has_cast = true, charged = true, reusable = true, spell = 'j_wlt_lightning_storm', mana_cost = 5, mana_cost_label = '' } },
...
SMODS.Joker {
    atlas = "jokers",
    pos = { x = 3, y = 5 },
    pixel_size = { w = 50, h = 50 }, -- Actual size 41 x 45
    key = "lightning_storm",
